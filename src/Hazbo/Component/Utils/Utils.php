...
class Utils
{
   ...
   * @group   util
   */
  public function mpull(array $list, $method, $key_method = null) {
    $result = array();
   ...
   * @group   util
   */
  public function ppull(array $list, $property, $key_property = null) {
    $result = array();
    foreach ($list as $key => $object) {
   ...
   * @group   util
   */
  public function mgroup(array $list, $by /* , ... */) {
    $map = mpull($list, $by);
   ...
   * @group   util
   */
  public function igroup(array $list, $by /* , ... */) {
    $map = ipull($list, $by);
   ...
   * @group   util
   */
  public function msort(array $list, $method) {
   ...
   * @group   util
   */
  public function isort(array $list, $index) {
   ...
   * @group  util
   */
  public function mfilter(array $list, $method, $negate = false) {
    if (!is_string($method)) {
   ...
   * @group  util
   */
  public function ifilter(array $list, $index, $negate = false) {
    if (!is_scalar($index)) {
   ...
   * @group   util
   */
  public function array_select_keys(array $dict, array $keys) {
    $result = array();
    foreach ($keys as $key) {
   ...
   * @group   util
   */
  public function assert_instances_of(array $arr, $class) {
   ...
   * @task   assert
   */
  public function assert_stringlike($parameter) {
   ...
   * @group util
   */
  public function newv($class_name, array $argv) {
   ...
   * @group util
   */
  public function last(array $arr) {
    return end($arr);
  }
   ...
   * @group util
   */
  public function head_key(array $arr) {
    reset($arr);
    return key($arr);
  }
   ...
   * @group util
   */
  public function last_key(array $arr) {
    end($arr);
    return key($arr);
  }
   ...
   * @group util
   */
  public function array_mergev(array $arrayv) {
    if (!$arrayv) {
      return array();
    }
   ...
   * @group util
   */
  public function phutil_split_lines($corpus, $retain_endings = true) {
    if (!strlen($corpus)) {
      return array('');
    }
   ...
   * @group util
   */
  public function array_fuse(array $list) {
    if ($list) {
   ...
   * @group util
   */
  public function array_interleave($interleave, array $array) {
    $result = array();
   ...
   * @group library
   */
  public function phutil_is_windows() {
   ...
   * @group library
   */
  public function phutil_is_hiphop_runtime() {
